...
private:
    ...
    Node* move_forward(Node* t, int l, int r) {
        pair<Node*, Node*> t12 = split(t, l - 1);
        pair<Node*, Node*> t23 = split(t12.second, r - l);
        Node* t1 = merge(t12.first, t23.second);
        t = merge(t23.first, t1);
        return t;
    }
...
public:
    ...
    void move_forward(int l, int r) {
        this->root = move_forward(this->root, l, r);
    };
